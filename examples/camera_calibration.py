...
distorted_img_filename = '../img/raw/image006.jpg'
...
def draw_corners(iter):

  filename = f"../img/raw/image{iter}.jpg"
  ...
  if success == True:
    ...
    new_filename = f'../img/drawn_corners/image{iter}.jpg'     
